...
- Добавлен архив заготовки проекта (Vite React TS) и базовая CI-конфигурация.
...
- Подготовлена UI-спецификация v1.0 (шаг 3/4) с экран-за-экраном для iOS/Android/Web (`docs/UI_SPEC.md`), структурирована валидация карты компонентов и дополнительные тесты на покрытие.
