...
- `createAreaServices(areas, lookup?)` и `createLayoutServices(tokens)` — чистые обёртки, которые можно изолированно тестировать без побочных эффектов.
...
- Если нужно быстро сориентироваться, откройте `docs/onboarding/README.md` — там список входных точек и команд.
